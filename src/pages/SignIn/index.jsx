        ...
        <div className="flex flex-wrap items-center gap-2 md:gap-3 w-full md:w-auto">
          <Link to="/">
            <div className="flex-1 md:flex-none flex items-center justify-center gap-3 w-full md:w-fit rounded-full border-2 border-[#e5e5e5] p-[12px_20px] md:p-[14px_24px] transition-all duration-300 hover:bg-[#ffb084] hover:shadow-lg bg-white group">
              <span className="font-semibold text-[#1a3a3a] group-hover:text-white transition-colors text-sm md:text-base">
                Home
              </span>
            </div>
          </Link>
      ...
      >
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex justify-end mt-1">
            <Link
              to="#"
              className="text-xs md:text-sm text-[#1a3a3a] hover:text-[#e85a49] hover:underline transition-colors"
            >
              Forgot Password?
            </Link>
          </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full rounded-xl border-2 border-[#e5e5e5] p-[14px_20px] md:p-[16px_24px] text-center font-semibold text-white text-sm md:text-base bg-gradient-to-r from-[#ff6b5a] to-[#ff6b5a] hover:from-[#e85a49] hover:to-[#ff6b5a] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:shadow-xl"
        >
