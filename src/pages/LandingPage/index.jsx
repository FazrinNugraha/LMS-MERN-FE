    ...
    <div className="relative flex flex-col min-h-screen bg-white overflow-hidden">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center flex-1 px-6 py-16 md:py-24">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute top-20 left-[5%] w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br from-[#ffb084] to-[#ff6b5a] rounded-3xl shadow-lg flex items-center justify-center animate-float">
            <img
          ...
          <div className="absolute top-12 left-[20%] w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#e8b94a] to-[#e8b94a] rounded-3xl shadow-lg flex items-center justify-center animate-float-delayed">
          ...
          <div className="absolute top-12 right-[20%] w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-[#ff6b5a] to-[#ff4d8b] rounded-3xl shadow-lg flex items-center justify-center animate-float">
            <svg className="w-7 h-7 md:w-8 md:h-8 text-white" fill="currentColor" viewBox="0 0 20 20">
        ...
        <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
          ...
          <Link to="/student/sign-in">
            <div className="group bg-white border-2 border-gray-100 hover:border-[#10B981] rounded-2xl p-6 transition-all duration-300 hover:shadow-xl cursor-pointer">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 bg-gradient-to-br from-[#a4d4c5] to-[#22c55e] rounded-xl flex items-center justify-center">
                  <img
                    src="/assets/images/icons/profile-2user-white.svg"
                    className="w-6 h-6"
                    alt="student"
